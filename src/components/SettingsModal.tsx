...
import {SettingsType, TransactionType} from "../types";
    ...
    <Modal isOpen={isOpen} closeable onClose={doClose}>
      <form onSubmit={doSave}>
        ...
        <ModalBody>
          <FormRow>
            ...
            <FormControl label="Rollover day (1-31)">
              <Input
                ...
                value={rolloverDay}
                onChange={(e) =>
                  setRolloverDay((e.target as HTMLInputElement).value)
                }
                min={1}
                max={31}
              />
            ...
            <div>
              <FormControl label="Transaction count">
                <Input
                  ...
                  onChange={(e) =>
                      setTransactionCount((e.target as HTMLInputElement).value)
                  }
                  min={1}
                  max={100}
                />
          ...
          <Button onClick={onClearTransactions} overrides={{
            BaseButton: {
              style: ({ $theme }) => {
                return {
